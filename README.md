...
**Keywords:** `ROS` `Navigation` `Path Planning` `Robot Control` `Computer Vision`
...
**Keywords:** `AI4LCA` `Benchmark` `Activity Matching` `Reproducible Evaluation`

---

## 📌 Selected Directions

- Robot navigation reliability under constrained competition environments.
- Failure analysis of LCA activity matching methods.
- Benchmark design for scientific evaluation rather than only demonstration.
- Practical engineering workflows combining code, experiments, and documentation.
...
_Engineering systems should be reproducible, explainable, and testable._
